    ...
    <div>
      <nav class="relative px-10 py-4 flex justify-between items-center bg-white">
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <a class="text-sm text-gray-400 hover:text-gray-500 hover:text-blue-500 hover:font-semibold" href="/User/menu"  >
              Menu
            </a>
          </li>
          ...
          <li>
          <a class="text-sm text-gray-400 hover:text-gray-500" href="/User/casa">
              Ejercicios en casa
            </a>
          </li>
          <li class="text-gray-300">
          ...
          <li>
            <a class="text-sm text-gray-400 hover:text-gray-500" href="/User/chat">
              Chat
            </a>
          </li>
          <li class="text-gray-300">
          ...
          <li>
            <a class="text-sm text-gray-400 hover:text-gray-500" href="/User/planes">
              Planes
            </a>
          </li>
          <li class="text-gray-300">
          ...
          <li>
            <Link to="/User/contacto" class="text-sm text-gray-400 hover:text-gray-500" >
              Contacto
            </Link>
          </li>
        </ul>
